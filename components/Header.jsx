...
import pranjal_header_black from "@/public/logos.png";
import pranjal_header_white from "@/public/logos.png";
...
const Header = () => {
  ...
  let Links = [
    ...
    { name: "Servis", link: "/timeline" },
    { name: "Proyektlarimiz", link: "/work" },
    { name: "Qanday ishlaymiz", link: "/tech" },
  ];
    ...
    >
      <div className="flex justify-between md:space-x-10 lg:space-x-12 xl:space-x-16 md:flex items-center place-items-center md:justify-center py-3 md:px-10 px-8">
        <div className="select-none order-2 md:order-1 cursor-pointer flex items-center text-gray-800">
          <Link href={"/"} className="">
            {currentTheme === "dark" ? (
              <Image src={pranjal_header_white} alt="header" width="120" />
            ) : (
              <Image src={pranjal_header_black} alt="header" width="120" />
            )}
          </Link>
          <Link href={"https://t.me/smkgroupsmchj"}>
          <div>
            <FaTelegram/>
