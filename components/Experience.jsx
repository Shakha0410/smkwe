  ...
  return (
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="w-[80%] mx-auto">
        ...
        SMK Web-dan veb-saytga sarmoya kiritish sizning biznesingiz rivojlanishiga bag&rsquo;ishlangan hamkorni tanlashni anglatadi. Samarali, konversiyaga yo&rsquo;naltirilgan veb-saytlarni yaratish bo&rsquo;yicha kuchli obro&rsquo;ga ega bo&rsquo;lgan SMK Web sizning onlayn mavjudligingizni va etakchilarni yaratish qobiliyatingizni sezilarli darajada oshiradigan arzon echimni taklif qiladi.
        </div>
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        <div className="drop-shadow-2xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl">
          ...
          React.js va Next.js markazlashtirilgan vositalariga e&rsquo;tibor qaratib, ixtisoslashgan
            vizual jozibali va intuitiv navigatsiya qilinadigan veb-saytlarni yaratish.
            Har bir loyihaga shaxsiyatning teginishi bizning imzoimdir
            teginish.
          </div>
        </div>
        <div className="drop-shadow-xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl rounded-[1.4rem] p-4 rounded-tl-none">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center">
          Badiiy qobiliyat va jonli ranglar palitrasi, dizayn bilan
            usta asarga aylanib, foydalanuvchini ishga kirishishga chorlaydi
            uning maqsadli va vizual jozibali elementlari bo&rsquo;ylab sayohat.
          </div>
        </div>
      ...
      <div className="w-[80%] max-w-2xl mx-auto">
        ...
        Bu biz ilgari ishlagan domen haqida qisqacha ma&rsquo;lumot edi. Shu bilan birga, yuqoridagi domendan foydalangan holda men yaratgan bir nechta tanlangan asarlarni ko&rsquo;rib chiqing.
        </div>
