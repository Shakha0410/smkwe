  ...
  const data = [
    {
      ...
      duration: "7-10 kun",
      org: "400$-800$",
      skills: ["1+page", "3D animatsya", "3D shkl qushiladi", "Yangi texnologiyadan foydalanish", "Dizayn"],
      class:
    ...
    },
    {
      ...
      duration: "3-7 kun",
      org: "250$-400$",
      skills: ["1+page", "1ta animatsya", "No 3D animatsya",],
      class:
