...
const tech = () => {
  const data = [
    {
      ...
      desc: "Hozirgacha mavjud bo'lgan eng yaxshi kodlash IDE tonnalab moslashtirish bilan birga keladi",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "Birinchi darajali funktsiyalarga ega engil, talqin qilingan yoki o'z vaqtida kompilyatsiya qilingan dasturlash tili.",
      tag: "code",
      bg: "bg-yellow-50",
    ...
    },
    {
      ...
      desc: "Microsoft tomonidan ishlab chiqilgan, ishonchli turdagi xavfsizlikka ega Javascriptning SuperScript.",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "Komponentlarga asoslangan foydalanuvchi interfeyslarini yaratish uchun bepul va ochiq manbali JavaScript-ning oldingi kutubxonasi",
      tag: "develop",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    {
      ...
      desc: "React-ga asoslangan veb-ilovalarni taqdim etuvchi ochiq manbali veb-ishlab chiqish tizimi.",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    {
      ...
      desc: "HTML-dan hech qachon chiqmasdan zamonaviy veb-saytlarni tez yaratish uchun yordamchi dastur bo'lgan birinchi CSS ramkasi.",
      tag: "design",
      bg: "bg-green-50",
      text: "text-green-500",
    },
    {
      ...
      desc: "Yangi funksiyalarni tezroq yetkazib berishga yordam beradigan UI vositalarining toʻliq toʻplami.",
      tag: "develop",
      bg: "bg-indigo-50",
    ...
    },
    {
      ...
      desc: "Super kuchlarga ega CSS. Dunyodagi eng kuchli professional CSS kengaytma tili.",
      tag: "design",
      bg: "bg-pink-300",
      text: "text-pink-800",
    },
    {
      ...
      desc: "Kundalik ish ilovalaringizni birlashtiradigan yangi vosita. Bu siz va jamoangiz uchun yaxlit ish maydoni.",
      tag: "productivity",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      ...
      desc: "Veb-ilova dizaynerlari uchun simli ramkadan tortib animatsiyagacha bo'lgan ne'mat - bularning barchasi mavjud.",
      tag: "design",
      bg: "bg-orange-500",
    ...
    },
    {
      ...
      desc: "Hamkorlik qilish va kodlarini namoyish qilish uchun ishlab chiquvchining asosiy platformasi.",
      tag: "platform",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      ...
      id: 11,
      main: "/brave-icon.svg",
      desc: "Maxfiylikka yo'naltirilgan brauzer reklamalar va qo'shimcha poplarni bloklash uchun ishlatiladi.",
      tag: "platform",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
  ...
  return (
    <div className="min-h-[75vh] md:min-h-[73vh] px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 xl:px-80 mx-auto">
      <Head>
        <title>Smk Web ✦ Texnik Toplam</title>
      ...
      <main className="max-w-screen max-w-5xl mx-auto">
        <div className="pt-24 flex flex-col mx-auto">
          ...
          Texnik to&rsquo;plam
          </h2>
          <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-sm md:text-base lg:text-xl mb-2 px-2">
          Har qanday boshqa ishlab chiquvchilar singari, biz ham qidirishga ko&rsquo;proq vaqt sarflaymiz va
            ba&rsquo;zi ma&rsquo;noli narsalarni kodlashdan ko&rsquo;ra tajriba vositalari.
          </p>
